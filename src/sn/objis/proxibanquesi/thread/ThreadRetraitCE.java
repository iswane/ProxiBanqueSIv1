 ...
 *
 */
public class ThreadRetraitCE extends Thread{
	// Attributs
	...
	// Constructeurs
	public ThreadRetraitCE() {
		super();
	}

	public ThreadRetraitCE(double montant, CompteEpargne compteE) {
		super();
	...
	public void run() {
		...
		synchronized (compteE) {
			try {
				...
				serviceCompteCourant.depot(compteE, montant);
				Thread.sleep(2000);
				System.out.println(Thread.currentThread().getName()
