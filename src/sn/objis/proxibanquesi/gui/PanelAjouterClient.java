...
public class PanelAjouterClient extends JPanel {
	...
	public PanelAjouterClient() {
		...
		JLabel lblTitre = new JLabel("Ajouter un nouveau client");
		...
		btnValider.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				String cpSaisi = tfCodePostale.getText();
				...
				areEmpty = (!codeSaisi.isEmpty()) && (!nomSaisi.isEmpty()) && (!prenomSaisi.isEmpty())
						&& (!emailSaisi.isEmpty()) && (!telephoneSaisi.isEmpty() && (!adresseSaisi.isEmpty())
								&& (!cpSaisi.isEmpty()) && (!villeSaisi.isEmpty()) && (!professionSaisi.isEmpty()));

				if (areEmpty = true) {

					Client client = new Client(codeSaisi, nomSaisi, prenomSaisi, telephoneSaisi, emailSaisi,
							adresseSaisi, cpSaisi, villeSaisi, professionSaisi);
