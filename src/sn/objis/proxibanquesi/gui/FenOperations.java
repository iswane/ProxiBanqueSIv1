...
public class FenOperations extends JFrame {
	...
	public FenOperations() {
		...
		btnRetrait
				.setIcon(new ImageIcon(FenOperations.class.getResource("/sn/objis/proxibanquesi/images/retrait.png")));
		...
		btnVirement.setIcon(new ImageIcon(FenOperations.class.getResource("/sn/objis/proxibanquesi/images/virement.png")));
		...
		btnDepot.setIcon(new ImageIcon(FenOperations.class.getResource("/sn/objis/proxibanquesi/images/depot.png")));
		btnDepot.setBounds(80, 253, 172, 82);
		panelCentre.add(btnDepot);

		JLabel lblVide = new JLabel("");
		lblVide.setIcon(new ImageIcon(FenOperations.class.getResource("/sn/objis/proxibanquesi/images/argent.png")));
		...
		lblReduire.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent arg0) {
				setState(FenOperations.ICONIFIED);
			}
		});
...
//				admin.setVisible(true);
		...
		lblFond.setIcon(new ImageIcon(FenOperations.class.getResource("/sn/objis/proxibanquesi/images/Accueil.png")));
