...
public class PanelAjouterEmploye extends JPanel implements ActionListener {
	...
	private IServiceRole serviceRole = new IServiceRoleImpl();
	...
	public PanelAjouterEmploye() {
		...
		tfCode.setBounds(148, 57, 160, 20);
		...
		lblLogin.setBounds(53, 102, 55, 20);
		...
		tfLogin.setBounds(148, 102, 160, 20);
		...
		tfNom.setColumns(10);
		tfNom.setBounds(148, 146, 160, 20);
		...
		tfTel.setColumns(10);
		tfTel.setBounds(148, 193, 160, 20);
		...
		lblRole.setBounds(53, 236, 46, 20);
		...
		rdbtnGerant.setBounds(148, 237, 71, 23);
		...
		rdbtnConseiller.setBounds(221, 237, 91, 23);
		...
		lblAgence.setBounds(53, 277, 61, 20);
		...
		btnAjouter.setBounds(197, 333, 111, 29);
		...
		btnAnnuler.setBounds(332, 333, 111, 29);
